        ...
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[0, 2.7, -119]}>
            ...
            <group position={[-88.64, -40.87, 274.96]} rotation={[-Math.PI, 0, Math.PI]} scale={[1.51, 1.51, 1.51]}>
              ...
              <group position={[-0.15, 0, -11.18]} scale={[0.65, 0.65, 0.65]}>
                <mesh
            ...
            <group position={[88.64, -40.87, 274.96]} scale={1.51}>
              ...
              <group position={[2.14, 0, 0]}>
                <mesh geometry={nodes.wheel003_020_Chrome_0.geometry} material={nodes.wheel003_020_Chrome_0.material} />
              </group>
              <group position={[5.39, 0, 0]}>
                <mesh geometry={nodes.wheel003_019_Chrome_0.geometry} material={nodes.wheel003_019_Chrome_0.material} />
              </group>
              <group position={[2.19, -0.31, -0.37]}>
                <mesh
